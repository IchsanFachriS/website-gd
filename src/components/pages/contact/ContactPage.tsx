            ...
            <div className="gd-contact-info">
              ...
              <div style={{ marginTop: "24px", background: "var(--gray-100)", height: "240px", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid var(--gray-200)" }}>
                <div style={{ textAlign: "center" }}>
                  ...
                  <a href="https://maps.google.com/?q=Gedung+Teknik+Geodesi+ITB+Bandung" target="_blank" rel="noreferrer" className="gd-btn gd-btn--outline" style={{ fontSize: "12px", padding: "8px 16px" }}>
                    Open in Google Maps
                  </a>
                </div>
              </div>
